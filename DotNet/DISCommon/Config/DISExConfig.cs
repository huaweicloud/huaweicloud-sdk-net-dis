...
namespace Com.Bigdata.Dis.Sdk.DISCommon.Config
{
    ...
    /// </summary>
    public class DISExConfig : ClientConfig
    {
        ...
        public DISExConfig()
        {
            this.AuthenticationServiceName = "dis";
        ...
        ~DISExConfig()
        {
            string strProduct = "eSDK-OBS-API-Windows-NET";// OBS.S3.ObsClient.strProduct;
            LoggerMgr.LogFini(strProduct);
        }
        /// <summary>
