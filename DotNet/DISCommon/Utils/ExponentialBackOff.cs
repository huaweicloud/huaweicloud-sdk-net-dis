...
namespace Com.Bigdata.Dis.Sdk.DISCommon.Utils
{
    public class ExponentialBackOff
    {
         ...
         */
        public static  long DEFAULT_INITIAL_INTERVAL = 50L;
         ...
         */
        public static  long DEFAULT_MAX_INTERVAL = 30000L;

        /**
         * The default maximum elapsed time.
         */
        public static long DEFAULT_MAX_ELAPSED_TIME = long.MaxValue;
        ...
        public ExponentialBackOff(long initialInterval, double multiplier, long maxInterval, long maxElapsedTime)
        {
            if (multiplier < 1)
            {
                throw new ArgumentException("Invalid multiplier '" + multiplier + "'. Should be greater than "
