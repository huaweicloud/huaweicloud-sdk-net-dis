...
namespace OBS.S3.Transfer
{
    public class TransferUtilityDownloadDirectoryRequest
    {
        ...
        /// <summary>
        /// 	Gets or sets the local directory where objects from Obs S3 will be downloaded.  
		/// 	If the directory doesn't exist, it will be created.
        /// </summary>
        /// <value>
        /// 	The local directory where objects from Obs S3 will be downloaded.
        /// </value>
        ...
        /// <summary>
        /// Gets or sets the Obs S3 directory to download from.  
        ...
        /// is downloaded from Obs S3.  The delegates attached to the event 
