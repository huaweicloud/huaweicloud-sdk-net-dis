...
namespace OBS.S3.Transfer
{
    ...
    public partial class TransferUtility : IDisposable
    {
        ...
        /// 	Obs S3's multipart API.  The parts will be reassembled as one object in
        /// 	Obs S3.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// 	The target Obs S3 bucket, that is, the name of the bucket to upload the files to.
        /// </param>
        ...
        /// <seealso cref="M:OBS.S3.Transfer.TransferUtility.UploadDirectory"/>
        /// </summary>
        /// <remarks>
        /// <para>
        /// If you are uploading large files, TransferUtility will use multipart upload to fulfill the request. 
        ...
        /// <exception cref="T:OBS.S3.ObsS3Exception"></exception>
        ...
        /// </param>
        /// <param name="bucketName">
        /// 	The target Obs S3 bucket, that is, the name of the bucket to upload the file to.
        /// </param>
        ...
        /// </param>
        /// <param name="key">
        /// 	The key under which the Obs S3 object is stored.
        /// </param>
        ...
        /// </param>
        /// <param name="bucketName">
        /// 	The target Obs S3 bucket, that is, the name of the bucket to upload the stream to.
        /// </param>
        /// <param name="key">
        /// 	The key under which the Obs S3 object is stored.
        /// </param>
        ...
        /// </remarks>
        /// <param name="request">
        /// 	Contains all the parameters required to upload to Obs S3.
        /// </param>
        ...
        /// <seealso cref="M:OBS.S3.Transfer.TransferUtility.Upload"/>
        /// </summary>
        /// <remarks>
        /// <para>
        /// If you are uploading large files, TransferUtility will use multipart upload to fulfill the request. 
        ...
        /// </param>
        /// <returns>
        /// 	A stream of the contents from the specified Obs S3 and key.
        /// </returns>
        ...
        /// <summary>
        /// 	Returns a stream to read the contents from Obs S3 as 
        ...
        /// </param>
        /// <returns>
        /// 	A stream of the contents from Obs S3.
        /// </returns>
        ...
        /// </summary>
        /// <param name="request">
        /// 	Contains all the parameters required to open a stream to an Obs S3 object.
        /// </param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback procedure using the AsyncState property.</param>
        /// <exception cref="T:System.ArgumentNullException"></exception>
        ...
        #region Download
        /// <summary>
        /// 	Downloads the content from Obs S3 and writes it to the specified file.  
        /// </summary>
        /// <param name="filePath">
        /// 	The file path where the content from Obs S3 will be written to.
        /// </param>
        /// <param name="bucketName">
        /// 	The name of the bucket containing the Obs S3 object to download.
        /// </param>
        /// <param name="key">
        /// 	The key under which the Obs S3 object is stored.
        /// </param>
        ...
        /// </summary>
        /// <param name="request">
        /// 	Contains all the parameters required to download an Obs S3 object.
        /// </param>
        ...
        /// <seealso cref="M:OBS.S3.Transfer.TransferUtility.Download"/>
        /// </summary>
        /// <param name="filePath">
        /// 	The file path where the content from Obs S3 will be written to.
        /// </param>
        ...
        /// <summary>
        /// 	Downloads the objects in Obs S3 that have a key that starts with the value 
        /// 	specified by <c>s3Directory</c>.
        /// </summary>
        /// <param name="bucketName">
        /// 	The name of the bucket containing the Obs S3 objects to download.
        /// </param>
        /// <param name="s3Directory">
        /// 	The directory in Obs S3 to download.
        /// </param>
        ...
        /// </summary>
        /// <param name="request">
        /// 	Contains all the parameters required to download objects from Obs S3 
        ...
        /// <seealso cref="M:OBS.S3.Transfer.TransferUtility.DownloadDirectory"/>
        /// </summary>
        /// <param name="bucketName">
        /// 	The name of the bucket containing the Obs S3 objects to download.
        /// </param>
        ...
        /// </summary>
        /// <param name="request">
        /// 	Contains all the parameters required to download objects from a directory in Obs S3 
        ...
        /// <seealso cref="M:OBS.S3.Transfer.TransferUtility.AbortMultipartUploads"/>
        /// </summary>
        /// <param name="bucketName">
        /// 	The name of the bucket containing multipart uploads.
        /// </param>
