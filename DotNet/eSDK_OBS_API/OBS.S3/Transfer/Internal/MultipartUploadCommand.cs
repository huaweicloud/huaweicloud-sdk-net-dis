...
namespace OBS.S3.Transfer.Internal
{
    ...
    internal partial class MultipartUploadCommand : BaseCommand
    {
        ...
        internal MultipartUploadCommand(IObsS3 s3Client, TransferUtilityConfig config, TransferUtilityUploadRequest fileTransporterRequest)
        {
            this._config = config;
        ...
        private string determineContentType()
        {
                ...
                this._fileTransporterRequest.IsSetKey())
            {
                ...
                string type = ObsS3Util.MimeTypeFromExtension(ext);
                return type;
            }
            return null;
        }
        ...
        private int CalculateConcurrentServiceRequests()
        {
            ...
            if (this._fileTransporterRequest.IsSetFilePath()
#if BCL
 && !(_s3Client is OBS.S3.Encryption.ObsS3EncryptionClient)
#endif
)
            {
