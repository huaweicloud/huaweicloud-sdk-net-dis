...
{
    public class ObsS3RetryPolicy : DefaultRetryPolicy
    {
        ...
        /// <summary>
        /// Constructor for ObsS3RetryPolicy.
        /// </summary>
        ...
        public ObsS3RetryPolicy(int maxRetries) :
            base(maxRetries)
        {
        }
        ...
        {
            var serviceException = exception as ObsServiceException;
            if (serviceException != null)
            {
                if (serviceException.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    if (ObsS3RetryPolicy.RequestsWith200Error.Contains(requestType))
                    {
                ...
                if (serviceException.StatusCode == HttpStatusCode.BadRequest)
                {
                        ...
                        )
                    {
                        ...
                        var s3Uri = new ObsS3Uri(r.Endpoint);
