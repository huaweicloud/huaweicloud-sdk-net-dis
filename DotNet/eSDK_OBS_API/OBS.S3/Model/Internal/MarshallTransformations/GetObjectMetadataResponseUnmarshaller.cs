...
namespace OBS.S3.Model.Internal.MarshallTransformations
{
    ...
    internal class GetObjectMetadataResponseUnmarshaller : S3ReponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context,GetObjectMetadataResponse response)
        {
            ...
            LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("GetObjectMetadataResponseUnmarshaller response xml context: {0}", reader.ReadToEnd()));
            ...
            foreach (var name in responseData.GetHeaderNames())
            {
                ...
                LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("GetObjectMetadataResponseUnmarshaller name: {0}, value: {1}", name, responseData.GetHeaderValue(name)));
            }
        ...
        public override ObsServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            //2015-5-27 w00322557
            LoggerMgr.Log_Run_Error(OBS.S3.ObsClient.strProduct,string.Format("GetObjectMetadataResponseUnmarshaller HttpStatus: {0}", statusCode.ToString()));
            LoggerMgr.Log_Run_Error(OBS.S3.ObsClient.strProduct,string.Format("GetObjectMetadataResponseUnmarshaller exception: {0}", innerException.Message));
