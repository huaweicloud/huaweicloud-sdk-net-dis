...
namespace OBS.S3.Model.Internal.MarshallTransformations
{
    ...
    internal class GetLifecycleConfigurationResponseUnmarshaller : S3ReponseUnmarshaller
    {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("Rule", targetDepth))
                    {
                        ...
                        //2015-5-27 w00322557
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("GetLifecycleConfigurationResponseUnmarshaller Rule."));
                        continue;
                    }
                    ...
                    if (context.TestExpression("Code", targetDepth))
                    {
                        ...
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("GetLifecycleConfigurationResponseUnmarshaller Code: {0}", ObsClient.errorCode));
                        continue;
                    }
                    ...
                    if (context.TestExpression("Message", targetDepth))
                    {
                        ...
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("GetLifecycleConfigurationResponseUnmarshaller Message: {0}", ObsClient.errorMessage));
                        continue;
                    }
                }
        ...
        public override ObsServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            //2015-5-27 w00322557
            LoggerMgr.Log_Run_Error(OBS.S3.ObsClient.strProduct,string.Format("GetLifecycleConfigurationResponseUnmarshaller HttpStatus: {0}", statusCode.ToString()));
            LoggerMgr.Log_Run_Error(OBS.S3.ObsClient.strProduct,string.Format("GetLifecycleConfigurationResponseUnmarshaller exception: {0}", innerException.Message));
