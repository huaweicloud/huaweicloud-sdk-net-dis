...
namespace OBS.S3.Model.Internal.MarshallTransformations
{
    ...
    internal class DeleteCORSConfigurationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override ObsServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            //2015-6-9 w00322557
            LoggerMgr.Log_Run_Error(OBS.S3.ObsClient.strProduct,string.Format("DeleteCORSConfigurationResponseUnmarshaller HttpStatus: {0}", statusCode.ToString()));
            LoggerMgr.Log_Run_Error(OBS.S3.ObsClient.strProduct,string.Format("DeleteCORSConfigurationResponseUnmarshaller exception: {0}", innerException.Message));
