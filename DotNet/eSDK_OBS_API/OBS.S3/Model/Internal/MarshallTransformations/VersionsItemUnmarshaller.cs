            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("ETag", targetDepth))
                    {
                        ...
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("VersionsItemUnmarshaller ETag: {0}",versionsItem.ETag));
                        continue;
                    }
                    if (context.TestExpression("IsLatest", targetDepth))
                    {
                        versionsItem.IsLatest = BoolUnmarshaller.GetInstance().Unmarshall(context);
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("VersionsItemUnmarshaller IsLatest: {0}", versionsItem.IsLatest));
                        continue;
                    }
                    if (context.TestExpression("Key", targetDepth))
                    {
                        versionsItem.Key = StringUnmarshaller.GetInstance().Unmarshall(context);
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("VersionsItemUnmarshaller Key: {0}", versionsItem.Key));
                        continue;
                    }
                    if (context.TestExpression("LastModified", targetDepth))
                    {
                        versionsItem.LastModified = DateTimeUnmarshaller.GetInstance().Unmarshall(context);
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("VersionsItemUnmarshaller LastModified: {0}", versionsItem.LastModified.ToLongDateString()));
                        continue;
                    }
                    if (context.TestExpression("Owner", targetDepth))
                    {
                        versionsItem.Owner = OwnerUnmarshaller.Instance.Unmarshall(context);
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("VersionsItemUnmarshaller Owner."));
                        continue;
                    }
                    if (context.TestExpression("Size", targetDepth))
                    {
                        versionsItem.Size = LongUnmarshaller.GetInstance().Unmarshall(context);
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("VersionsItemUnmarshaller Size: {0}", versionsItem.Size));
                        continue;
                    }
                    if (context.TestExpression("StorageClass", targetDepth))
                    {
                        versionsItem.StorageClass = StringUnmarshaller.GetInstance().Unmarshall(context);
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("VersionsItemUnmarshaller StorageClass: {0}", versionsItem.StorageClass.Value));
                        continue;
                    }
                    if (context.TestExpression("VersionId", targetDepth))
                    {
                        versionsItem.VersionId = StringUnmarshaller.GetInstance().Unmarshall(context);
                        LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("VersionsItemUnmarshaller VersionId: {0}", versionsItem.VersionId));
                        continue;
                    }
                }
