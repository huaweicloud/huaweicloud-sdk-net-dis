...
namespace OBS.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetBucketWebsiteRequestMarshaller : IMarshaller<IRequest, GetBucketWebsiteRequest> ,IMarshaller<IRequest,OBS.Runtime.ObsWebServiceRequest>
	{
        ...
        public IRequest Marshall(GetBucketWebsiteRequest getBucketWebsiteRequest)
        {
            ...
            //2015-5-27 w00322557
            LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("GetBucketWebsiteRequestMarshaller HttpMethod: {0}", request.HttpMethod));

            request.ResourcePath = string.Concat("/", S3Transforms.ToStringValue(getBucketWebsiteRequest.BucketName));
            //2015-5-27 w00322557
            LoggerMgr.Log_Run_Info(OBS.S3.ObsClient.strProduct,string.Format("GetBucketWebsiteRequestMarshaller ResourcePath: {0}", request.ResourcePath));
