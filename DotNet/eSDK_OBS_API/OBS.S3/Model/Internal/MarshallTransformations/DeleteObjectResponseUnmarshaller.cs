...
namespace OBS.S3.Model.Internal.MarshallTransformations
{
    ...
    internal class DeleteObjectResponseUnmarshaller : S3ReponseUnmarshaller
    {
        ...
        public override ObsServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            //2015-5-27 w00322557
            LoggerMgr.Log_Run_Error(OBS.S3.ObsClient.strProduct,string.Format("DeleteObjectResponseUnmarshaller HttpStatus: {0}", statusCode.ToString()));
            LoggerMgr.Log_Run_Error(OBS.S3.ObsClient.strProduct,string.Format("DeleteObjectResponseUnmarshaller exception: {0}", innerException.Message));
