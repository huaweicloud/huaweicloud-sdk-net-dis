...
namespace OBS.S3.Model
{
    ...
    public class GetObjectMetadataResponse : ObsWebServiceResponse
    {
        ...
        /// RestoreExpiration will be set for objects that have been restored from Obs Glacier.  
        ...
        /// Will be true when the object is in the process of being restored from Obs Glacier.
        /// </summary>
        ...
        { 
            get
            {
                if (this.serverSideCustomerEncryption == null)
                    return ServerSideEncryptionCustomerMethod.None;

                return this.serverSideCustomerEncryption;
            }
        ...
        {
            return this.serverSideCustomerEncryption != null;
        }
