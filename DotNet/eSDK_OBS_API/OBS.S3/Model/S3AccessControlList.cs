...
namespace OBS.S3.Model
{
    ...
    /// <remarks>
    /// <para>
    /// Each bucket and object in Obs S3 has an ACL that defines its access control policy.
    /// When a request is made, Obs S3 authenticates the request using its standard
    ...
    /// Otherwise, Obs S3 returns an error.
    /// </para>
    /// <para>
    ...
    public class S3AccessControlList
    {
        ...
        /// <remarks>
        /// <para>
        /// Every bucket and object in Obs S3 has an owner, the user that
