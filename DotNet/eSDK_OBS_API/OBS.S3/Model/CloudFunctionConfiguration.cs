...
namespace OBS.S3.Model
{
    ...
    /// and send the event to an Obs Lambda cloud function.
    /// </summary>
    public class CloudFunctionConfiguration
    {
        ...
        /// <summary>
        /// Gets and sets the Events property. These are the events the configuration will listen to and send to the Obs Lambda cloud function.
        /// </summary>
        ...
        /// <summary>
        /// Gets and sets the CloudFormation property. This is the Obs Lambda cloud function to which Obs S3 will invoke with the events.
        /// </summary>
