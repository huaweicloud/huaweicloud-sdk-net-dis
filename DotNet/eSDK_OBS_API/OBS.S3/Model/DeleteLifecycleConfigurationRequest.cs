...
namespace OBS.S3.Model
{
    ...
    /// <remarks>
    /// <para>
    /// Obs S3 removes all the lifecycle configuration rules in the lifecycle subresource associated with the bucket. 
    /// Your objects never expire, and Obs S3 no longer automatically deletes any objects on the basis of rules contained 
    ...
    /// </para>
    /// <para>
    /// There is usually some time lag before lifecycle configuration deletion is fully propagated to all the Obs S3 systems.
    /// </para>
    /// </remarks>
    public partial class DeleteLifecycleConfigurationRequest : ObsWebServiceRequest
    {
