...
{
    /// <summary>
    /// Returns information about the  GetBucketLifecycleConfiguration response and response metadata.
    /// </summary>
    public class GetLifecycleConfigurationResponse : ObsWebServiceResponse
    {
