...
namespace OBS.S3.Model
{
    ...
    public partial class PutObjectRequest : PutWithACLRequest
    {
        ...
        private string serverSideEncryptionContent;
        ...
        /// Please refer to <see cref="T:OBS.S3.S3CannedACL"/> for
        ...
        /// Default: true.
        /// </summary>
        internal bool AutoResetStreamPosition
        {
        ...
        /// <summary>
        /// The base64-encoded encryption key for Obs S3 to use to encrypt the object
        /// <para>
        /// Using the encryption key you provide as part of your request Obs S3 manages both the encryption, as it writes 
        /// to disks, and decryption, when you access your objects. Therefore, you don't need to maintain any data encryption code. The only 
        /// thing you do is manage the encryption keys you provide.
        /// </para>
        /// <para>
        /// When you retrieve an object, you must provide the same encryption key as part of your request. Obs S3 first verifies 
        /// the encryption key you provided matches, and then decrypts the object before returning the object data to you.
        /// </para>
        /// <para>
        /// Important: Obs S3 does not store the encryption key you provide.
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// The id of the AWS Key Management Service key that Obs S3 should use to encrypt and decrypt the object.
        ...
        /// 
        /// </summary>
        public string ServerSideEncryptionContent
        {
            get { return this.serverSideEncryptionContent; }
            set { this.serverSideEncryptionContent = value; }
        }

        /// <summary>
        /// Checks if ServerSideEncryptionContent property is set.
        /// </summary>
        /// <returns>true if ServerSideEncryptionContent property is set.</returns>
        internal bool IsSetServerSideEncryptionContent()
        {
            return !System.String.IsNullOrEmpty(this.serverSideEncryptionContent);
        }
        ...
        ///  
        /// </summary>
        internal S3StorageClass StorageClass
        {
        ...
        /// Obs S3 stores the value of this header in the object metadata.
        ///  
        /// </summary>
        ...
        /// </summary>
        internal EventHandler<OBS.Runtime.StreamTransferProgressArgs> StreamTransferProgress
        {
            get
            {
