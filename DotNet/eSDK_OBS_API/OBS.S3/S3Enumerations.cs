...
namespace OBS.S3
{
    ...
    /// <see href="http://docs.amazonwebservices.com/ObsS3/latest/RESTAccessPolicy.html#RESTCannedAccessPolicies"/>.
    /// </summary>
    public sealed class S3CannedACL : ConstantClass
    {
        ...
        /// <summary>
        /// Owner gets FULL_CONTROL, and any principal authenticated as a registered Obs
    ...
    /// <see href="http://docs.amazonwebservices.com/ObsS3/latest/BucketConfiguration.html#LocationSelection"/>.
    /// </summary>
    ...
    /// <see href="http://docs.amazonwebservices.com/ObsS3/latest/S3_ACLs.html#S3_ACLs_Permissions"/>.
    /// </summary>
    public sealed class S3Permission : ConstantClass
    {
        ...
        /// <summary>
        /// Gives permission to restore an object that is currently stored in Obs Glacier
    ...
    public sealed class S3StorageClass : ConstantClass
    {
        ...
        /// <summary>
        /// The STANDARD_IA storage class for S3 objects. This
        ...
        /// <summary>
        /// The GLACIER storage is for object that are stored in Obs Glacier.
    ...
    public sealed class GranteeType : ConstantClass
    {
        ...
        /// </summary>
        public static readonly GranteeType Email = new GranteeType("ObsCustomerByEmail");
    ...
    /// <summary>
    /// A FilterNameType that can configured with the bucket notification configuration.
    /// </summary>
    public sealed class FilterNameType : ConstantClass
    {
        /// <summary>
        /// prefixFilter for Name Filter
        /// </summary>
        public static readonly FilterNameType prefixFilter = new FilterNameType("prefix");

        /// <summary>
        /// suffixFilter for  Name Filter
        /// </summary>
        public static readonly FilterNameType suffixFilter = new FilterNameType("suffix");



        public FilterNameType(string value)
            : base(value)
        {
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static FilterNameType FindValue(string value)
        {
            return FindValue<FilterNameType>(value);
        }

        public static implicit operator FilterNameType(string value)
        {
            return FindValue(value);
        }
