/*******************************************************************************
 *  Copyright 2008-2011 OBS.com, Inc. or its affiliates. All Rights Reserved.
...
namespace OBS.S3.IO
{
    ...
    public sealed class S3DirectoryInfo : IS3FileSystemInfo
    {
        ...
        private IObsS3 s3Client;
        private string bucket;
        private string key;

        internal IObsS3 S3Client
        {
            get
            {
                return s3Client;
        ...
        public S3DirectoryInfo(IObsS3 s3Client, string bucket)
        ...
        /// <exception cref="T:System.ArgumentNullException"></exception>
        public S3DirectoryInfo(IObsS3 s3Client, string bucket, string key)
        {
            if (s3Client == null)
            {
        ...
        /// 
        /// Due to Obs S3's eventual consistency model this property can return false for newly created buckets.
        /// </summary>
        ...
        /// <exception cref="T:System.Net.WebException"></exception>
        /// <exception cref="T:OBS.S3.ObsS3Exception"></exception>
        /// <exception cref="T:OBS.S3.Model.DeleteObjectsException"></exception>
        public void Delete()
        {
            Delete(false);
        }
