...
namespace OBS.S3.Encryption
{
    ...
    public static class EncryptionUtils
    {
        ...
        /// </summary>
        /// <param name="request">
        /// ObsWebServiceRequest  encrypted using the given instruction
        /// </param>
        /// <param name="instructions">
        /// Non-null instruction used to encrypt the data in this ObsWebServiceRequest .
        /// </param>
        internal static void UpdateMetadataWithEncryptionInstructions(ObsWebServiceRequest request, EncryptionInstructions instructions)
        {
        ...
        internal static PutObjectRequest CreateInstructionFileRequest(ObsWebServiceRequest request, EncryptionInstructions instructions)
        {
