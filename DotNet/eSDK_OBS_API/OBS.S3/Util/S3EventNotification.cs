...
namespace OBS.S3.Util
{
    ...
    public class S3EventNotification 
    {
        ...
        /// </para>
        /// <exception cref="OBS.Runtime.ObsClientException">For any parsing errors</exception>
        /// </summary>
        public static S3EventNotification ParseJson(string json) 
        {
            ...
            {
                throw new ObsClientException("Failed to parse json string: " + e.Message, e);
            }
        }
        ...
        {
            /// <summary>
            /// Gets and sets the XAmzId2 Property. This is the Obs S3 host that processed the request.
            /// </summary>
            public string XAmzId2 {get;set;}

            /// <summary>
            /// Gets and sets the XAmzRequestId. This is the Obs S3 generated request ID.
            /// </summary>
