...
namespace OBS.S3.Util
{
    ...
    public static partial class ObsS3Util
    {
        ...
        /// <seealso href="http://docs.amazonwebservices.com/ObsS3/2006-03-01/dev/index.html?BucketRestrictions.html">
        ...
        public static bool ValidateV2Bucket(string bucketName)
        {
            ...
            // strip out the Obs S3 part of the URL
        ...
        internal static void ParseAmzRestoreHeader(string header, out bool restoreInProgress, out DateTime? restoreExpiration)
        {
            ...
            if (pos != -1)
            {
                ...
                string value = header.Substring(startPos, endPos - startPos);
                DateTime parseDate;
                if (DateTime.TryParseExact(value, OBS.Util.AWSSDKUtils.RFC822DateFormat, CultureInfo.InvariantCulture, DateTimeStyles.None, out parseDate))
