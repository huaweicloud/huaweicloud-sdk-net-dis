...
namespace OBS.S3.Util
{
    /// <summary>
    /// Provides utilities used by the Obs S3 client implementation.
    /// These utilities might be useful to consumers of the Obs S3
    /// library.
    /// </summary>
    public static partial class ObsS3Util
    {
        /// <summary>
        ...
        /// <param name="s3Client">The Obs S3 Client to use for S3 specific operations.</param>
        /// <returns></returns>
        public static bool DoesS3BucketExist(IObsS3 s3Client, string bucketName)
        {
            if (s3Client == null)
            {
            ...
            var uri = new Uri(url.TempSignUrl);

            var httpRequest = WebRequest.Create(uri) as HttpWebRequest;
            if (httpRequest == null)
            {
                throw new SystemException("httpRequest is null");
            }
            httpRequest.Method = "HEAD";
            var concreteClient = s3Client as ObsS3Client;
        ...
        /// <param name="s3Client">The Obs S3 Client to use for S3 specific operations.</param>
        /// <seealso cref="T:OBS.S3.S3StorageClass"/>
        public static void SetObjectStorageClass(IObsS3 s3Client, string bucketName, string key, S3StorageClass sClass)
        {
        ...
        /// <param name="s3Client">The Obs S3 Client to use for S3 specific operations.</param>
        /// <seealso cref="T:OBS.S3.S3StorageClass"/>
        public static void SetObjectStorageClass(IObsS3 s3Client, string bucketName, string key, string version, S3StorageClass sClass)
        {
        ...
        /// <param name="s3Client">The Obs S3 Client to use for S3 specific operations.</param>
        public static void SetServerSideEncryption(IObsS3 s3Client, string bucketName, string key, ServerSideEncryptionMethod method)
        {
        ...
        /// <param name="method">The server side encryption method</param>
        /// <param name="s3Client">The Obs S3 Client to use for S3 specific operations.</param>
        public static void SetServerSideEncryption(IObsS3 s3Client, string bucketName, string key, string version, ServerSideEncryptionMethod method)
        {
            CopyObjectRequest copyRequest;
            PutACLRequest putACLRequest;
        ...
        /// <param name="s3Client">The Obs S3 Client to use for S3 specific operations.</param>
        public static void SetWebsiteRedirectLocation(IObsS3 s3Client, string bucketName, string key, string websiteRedirectLocation)
        {
            CopyObjectRequest copyRequest;
            PutACLRequest putACLRequest;
        ...
        static void SetupForObjectModification(IObsS3 s3Client, string bucketName, string key, string version,
        ...
        /// <param name="s3Client">The Obs S3 Client to use for S3 specific operations.</param>
        public static void DeleteS3BucketWithObjects(IObsS3 s3Client, string bucketName)
        {
        ...
        public static void DeleteS3BucketWithObjects(IObsS3 s3Client, string bucketName, S3DeleteBucketWithObjectsOptions deleteOptions)
        {
        ...
        public static IAsyncCancelableResult BeginDeleteS3BucketWithObjects(IObsS3 s3Client,string bucketName, 
        ...
        private static void DeleteS3BucketWithObjectsInternal(IObsS3 s3Client, string bucketName, 
        ...
        /// </summary>
        /// <param name="value">Obs S3 string values for storage class</param>
        ...
        /// <summary>
        /// Upload data to Obs S3 using HTTP POST.
        /// </summary>
        /// <remarks>
        /// For more information, <see href="http://docs.aws.amazon.com/ObsS3/latest/dev/UsingHTTPPOST.html"/>
        /// </remarks>
