...
namespace OBS.S3.Util
{
    internal static class S3Constants
    {
        ...
        #region 2015-5-28 w00322557 Error Codes and message
        
        internal const string InvalidBucketName = "InvalidBucketName";
        internal const string InvalidBucketNameMessage = "The specified bucket is not valid.";

        internal const string InvalidArgument = "InvalidArgument";
        internal const string InvalidArgumentMessage = "Invalid argument.";

        internal const string NoSuchKey = "NoSuchKey";
        internal const string NoSuchKeyMessage = "The specified key is not exist.";
