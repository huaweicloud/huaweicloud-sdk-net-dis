...
{
    /// <summary>
    /// AWS access control policy conditions are contained in <see cref="OBS.Auth.AccessControlPolicy.Statement"/>
    /// objects, and affect when a statement is applied. For example, a statement
    /// that allows access to an Obs SQS queue could use a condition to only apply
    ...
    /// example, using <see cref="OBS.Auth.AccessControlPolicy.ConditionFactory.SOURCE_IP_CONDITION_KEY"/> will cause
    ...
    public class Condition
    {
        ...
        /// <para>
        /// Obst conditions accept only one value, but multiple values are possible.
        /// </para>
        /// </summary>
