...
namespace OBS.Auth.AccessControlPolicy.ActionIdentifiers
{
    /// <summary>
    /// The available AWS access control policy actions for Obs SES.
    /// </summary>
    /// <see cref="OBS.Auth.AccessControlPolicy.Statement.Actions"/>
