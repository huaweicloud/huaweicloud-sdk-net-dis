...
namespace OBS.Auth.AccessControlPolicy
{
    ...
    /// Statement object, not directly the <see cref="OBS.Auth.AccessControlPolicy.Policy"/> object.
    /// <para>
    ...
    /// authenticated AWS users through the <see cref="OBS.Auth.AccessControlPolicy.Principal.AllUsers"/> member. This
