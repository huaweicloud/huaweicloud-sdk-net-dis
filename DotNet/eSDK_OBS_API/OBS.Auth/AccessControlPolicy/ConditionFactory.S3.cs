...
namespace OBS.Auth.AccessControlPolicy
{
    public static partial class ConditionFactory
    {
        ...
        /// <summary>
        /// Constructs a new access policy condition that compares an Obs S3
        ...
        /// Obs S3 bucket have a specific canned ACL set.
        /// </para>
        /// </summary>
        /// <param name="cannedAcl">The Obs S3 canned ACL to compare against.</param>
        /// <returns>A new access control policy condition that compares the Obs S3
