...
namespace OBS.Auth.AccessControlPolicy
{
    ...
    ///             as sending a message to an Obs SQS queue, or storing an object in an Obs S3 bucket.
    ///         </description>
    ///     </item>
    ///     <item>
    ///         <term>C is the resource</term>
    ///         <description>your AWS entity that the principal wants to access, such
    ///             as an Obs SQS queue, or an object stored in Obs S3.
    ///         </description>
    ///     </item>
    ///     <item>
    ...
    public class Statement 
    {
       ...
       /// <summary>
        ...
        /// Obs SQS queue or an Obs SNS topic.
        /// <para>
        ...
        /// such as an Obs SQS queue or an Obs SNS topic.
        /// </para>
        /// <para>
        /// Note that some services allow only one resource to be specified per
        /// policy statement.
        ...
        /// <para>
        /// For example, a statement that allows access to an Obs SQS queue could
        ...
        /// <see cref="OBS.Auth.AccessControlPolicy.Principal.AllUsers"/> to apply the policy to any user trying to
