...
namespace OBS.Auth.AccessControlPolicy
{
    /// <summary>
    ...
    public static partial class ConditionFactory
    {
        ...
        /// <para>
        /// This condition key should only be used with <see cref="OBS.Auth.AccessControlPolicy.ConditionFactory.DateComparisonType"/> enum.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// This condition key should only be used with <see cref="OBS.Auth.AccessControlPolicy.ConditionFactory.IpAddressComparisonType"/> enum.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// This condition key should only be used with <see cref="OBS.Auth.AccessControlPolicy.ConditionFactory.StringComparisonType"/>
        /// enum.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// This condition key should only be used with <see cref="OBS.Auth.AccessControlPolicy.ConditionFactory.NumericComparisonType"/> enum.
        /// objects.
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Condition key for the Obs Resource Name (ARN) of the source specified
        ...
        /// <para>
        /// This condition key should only be used with <see cref="OBS.Auth.AccessControlPolicy.ConditionFactory.ArnComparisonType"/> enum.
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Constructs a new access control policy condition that compares ARNs (Obs Resource Names).
        /// </summary>
        ...
        /// <summary>
        /// Constructs a new access policy condition that compares the Obs
        /// Resource Name (ARN) of the source of an AWS resource that is modifying
        /// another AWS resource with the specified pattern.
        /// <para>
        /// For example, the source ARN could be an Obs SNS topic ARN that is
        /// sending messages to an Obs SQS queue. In that case, the SNS topic ARN
