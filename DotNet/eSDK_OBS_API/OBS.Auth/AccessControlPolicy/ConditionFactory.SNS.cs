...
namespace OBS.Auth.AccessControlPolicy
{
    public static partial class ConditionFactory
    {
        ...
        /// *@mycompany.com).
        /// <para>
        /// This condition key may only be used with <see cref="OBS.Auth.AccessControlPolicy.ConditionFactory.StringComparisonType"/> enum.
        /// </para>
        /// </summary>
        ...
        /// endpoint used to subscribe to an Obs SNS topic with the specified
        ...
        ///            endpoint for an Obs SNS topic subscription.</param>
        /// <returns>A new access control policy condition that compares the endpoint
        ///         used in a request to subscribe to an Obs SNS topic with the
        ...
        /// access control statement to restrict subscriptions to an Obs SNS topic
        ...
        ///            for an Obs SNS topic subscription.</param>
        ...
        ///         Obs SNS topic with the protocol value specified.</returns>
