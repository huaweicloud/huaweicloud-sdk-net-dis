...
namespace OBS.Auth.AccessControlPolicy
{
    ...
    /// Resources are the service specific AWS entities owned by your account. Obs
    /// SQS queues, Obs S3 buckets and objects, and Obs SNS topics are all
    /// examples of AWS resources.
    /// <para>
    /// The standard way of specifying an AWS resource is with an Obs Resource
    /// Name (ARN).
    /// </para>
    /// <para>
    ...
    public class Resource
    {
        ...
        /// typically specified as Obs Resource Names (ARNs).
        /// <para>
        /// You specify the resource using the following Obs Resource Name (ARN)
        ...
        /// </para>
        /// <para>
        /// For example, an Obs SQS queue might be addressed with the following
        /// ARN: arn:aws:sqs:us-east-1:987654321000:MyQueue
        /// </para>
        /// <para>
        /// Some resources may not use every field in an ARN. For example, resources
        /// in Obs S3 are global, so they omit the region field:
        /// arn:aws:s3:::bucket/*
        /// </para>
        /// </summary>
        /// <param name="resource">The Obs Resource Name (ARN) uniquely identifying the desired AWS resource.</param>
        ...
        /// <summary>
        /// Gets the resource ID, typically an Obs Resource Name (ARN),
