/*******************************************************************************
 *  Copyright 2014 OBS.com, Inc. or its affiliates. All Rights Reserved.
...
using OBS.Runtime;
using OBS.Runtime.Internal.Settings;
...
namespace OBS.Util
{
    ...
    public static class ProfileManager
    {
        ...
        /// <exception cref="ObsClientException">Thrown if the profile does not exist</exception>
        public static AWSCredentials GetAWSCredentials(string profileName)
        {
            ...
            if (!TryGetAWSCredentials(profileName, out credentials))
                throw new ObsClientException(string.Format(CultureInfo.InvariantCulture, "The account name {0} has not been registered.", profileName));
