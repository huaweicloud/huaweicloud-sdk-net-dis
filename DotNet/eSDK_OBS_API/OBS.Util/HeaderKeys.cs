...
namespace OBS.Util
{
    public abstract class HeaderKeys
    {
        ...
        //2015-6-10 w00322557 Added Options request headers
        ...
        public const string XAmzServerSideEncryptionContent = "x-amz-server-side-encryption-context";
        ...
        public const string XAmzDefaultStorageClassHeader = "x-default-storage-class";
        ...
        public const string XAmzRestoreHeader = "x-amz-restore";
    }
}
