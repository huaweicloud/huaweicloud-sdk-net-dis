...
namespace OBS.Runtime
{
    public class AbstractWebServiceClient : IDisposable
    {
        ...
        /// <summary>
        /// Implements the Dispose pattern for the ObsWebServiceClient
        /// </summary>
        ...
        protected virtual void ProcessPreRequestHandlers(ObsWebServiceRequest request)
        {
            if (request == null)
                return;
        ...
        protected virtual void ProcessResponseHandlers(ObsWebServiceResponse response, IRequest request, IWebResponseData webResponseData)
        {
            if (request == null)
                return;
        ...
        protected void LogFinishedResponse(RequestMetrics metrics, UnmarshallerContext context, long contentLength)
        {
            ...
            if (SupportResponseLogging && (Config.LogResponse || ObsConfigs.LoggingConfig.LogResponses == ResponseLoggingOption.Always))
            {
        ...
        public static bool ShouldRetry(HttpStatusCode statusCode, ClientConfig config, ObsServiceException errorResponseException, int retries)
        {
