...
namespace OBS.Runtime.Internal.Transform
{
    ...
    public class XmlUnmarshallerContext : UnmarshallerContext
    {
        ...
        //private static readonly XmlReaderSettings READER_SETTINGS = new XmlReaderSettings() { DtdProcessing = DtdProcessing.Ignore, IgnoreWhitespace = true ,IgnoreComments = true};
        private static readonly XmlReaderSettings READER_SETTINGS = new XmlReaderSettings() { ProhibitDtd = false, XmlResolver=null, IgnoreWhitespace = true, IgnoreComments = true };

#else
        private static  XmlReaderSettings READER_SETTINGS = new XmlReaderSettings() { DtdProcessing = DtdProcessing.Ignore, IgnoreWhitespace = true };
#endif
        ...
        public override bool Read()
        {
                ...
                !_checkedForErrorResponse)
            {
                ...
                if (this.IsStartElement)
                {
                    ...
                    {
                        // Thrown an exception
                        var errorResponse = new OBS.S3.Model.Internal.MarshallTransformations.S3ErrorResponseUnmarshaller().Unmarshall(this);

                        throw new OBS.S3.ObsS3Exception(
