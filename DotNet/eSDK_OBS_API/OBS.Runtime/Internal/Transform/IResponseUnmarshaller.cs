...
namespace OBS.Runtime.Internal.Transform
{
    ...
    /// <c>OBS.Runtime.Internal.Transform.UnmarshallerContext</c>.</typeparam>
    public interface IResponseUnmarshaller<T, R> : IUnmarshaller<T, R>
    {
        ...
        ObsServiceException UnmarshallException(R input, Exception innerException, HttpStatusCode statusCode);
    }
}
