...
namespace OBS.Runtime.Internal
{
    ...
    internal class DefaultRequest : IRequest
    {
        ...
        string resourcePath;
        string serviceName;
        readonly ObsWebServiceRequest originalRequest;
        byte[] content;
        ...
        public DefaultRequest(ObsWebServiceRequest request, String serviceName)
        {
        ...
        /// </summary>
        public ObsWebServiceRequest OriginalRequest
        {
            get
            {
        ...
        /// This is used primarily for Obs S3, where object keys can contain '?'
        ...
        /// (applies to Obs S3 PutObject and UploadPart requests only). 
        /// </summary>
        /// <returns></returns>
        public bool UseChunkEncoding { get; set; }

        /// <summary>
        /// Used for Obs S3 requests where the bucket name is removed from
