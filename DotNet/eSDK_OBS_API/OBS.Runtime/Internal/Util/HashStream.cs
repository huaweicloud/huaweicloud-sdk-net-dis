...
namespace OBS.Runtime.Internal.Util
{
    ...
    /// Close or CalculateHash methods will throw an ObsClientException.
    /// If CalculatedHash is calculated for only the portion of the stream that
    /// is read.
    /// </summary>
    /// <exception cref="OBS.Runtime.ObsClientException">
    ...
    public abstract class HashStream : WrapperStream
    {
        ...
        /// If the hashes are different, an ObsClientException is thrown.
        /// </summary>
        ...
        /// If an ExpectedHash is specified and is not equal to the calculated hash,
        /// this method will throw an ObsClientException.
        /// </summary>
        /// <exception cref="OBS.Runtime.ObsClientException">
