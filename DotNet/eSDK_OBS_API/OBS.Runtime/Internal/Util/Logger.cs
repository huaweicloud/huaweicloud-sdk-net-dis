...
namespace OBS.Runtime.Internal.Util
{
    ...
    public class Logger : ILogger
    {
...
#endif
            ConfigureLoggers();
            ObsConfigs.PropertyChanged += ConfigsChanged;
        }
        private void ConfigsChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e != null && string.Equals(e.PropertyName, ObsConfigs.LoggingDestinationProperty, StringComparison.Ordinal))
            {
                ConfigureLoggers();
            }
        }
        ...
        {
            LoggingOptions logging = ObsConfigs.LoggingConfig.LogTo;
