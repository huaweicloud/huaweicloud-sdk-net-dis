...
namespace OBS.Runtime
{
    ...
    /// </summary>
    public class ObsUnmarshallingException : ObsServiceException
    {
        private string lastKnownLocation;

        public ObsUnmarshallingException(string requestId, string lastKnownLocation, Exception innerException)
