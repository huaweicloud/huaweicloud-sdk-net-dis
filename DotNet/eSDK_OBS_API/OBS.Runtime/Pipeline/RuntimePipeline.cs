...
namespace OBS.Runtime.Internal
{
    ...
    public partial class RuntimePipeline : IDisposable
    {
        ...
        // The top-Obst handler in the pipeline.
        ...
        public RuntimePipeline(IPipelineHandler handler) 
        {
            ...
            var logger =
                 OBS.Runtime.Internal.Util.Logger.GetLogger(typeof(RuntimePipeline));
        ...
        public RuntimePipeline(IList<IPipelineHandler> handlers)
            : this(handlers, OBS.Runtime.Internal.Util.Logger.GetLogger(typeof(RuntimePipeline)))
        {            
        }
        ...
        public void AddHandler(IPipelineHandler handler)
        {
            ...
            var innerObstHandler = GetInnerObstHandler(handler);

            if (_handler != null)
            {
                innerObstHandler.InnerHandler = _handler;
                _handler.OuterHandler = innerObstHandler;    
            }
        ...
        private static void InsertHandler(IPipelineHandler handler, IPipelineHandler current)
        {
            ...
            {
                var innerObstHandler = GetInnerObstHandler(handler);
                innerObstHandler.InnerHandler = next;
                next.OuterHandler = innerObstHandler;
            }
        }

        /// <summary>
        /// Gets the innerObst handler by traversing the inner handler till 
        /// it reaches the last one.
        /// </summary>
        private static IPipelineHandler GetInnerObstHandler(IPipelineHandler handler)
        {
